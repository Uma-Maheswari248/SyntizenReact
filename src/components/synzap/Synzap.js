...
export class Synzap extends Component {
  ...
  render() {
        ...
        <div className="container">
            <div className="row ekyc-row">
                <div className="col-md-6 col-md-offset-3 col-xs-12 text-center">
                    <h2 className="def-h2">Tamper-proof,Authentic & Easy to Integrate
                        <span className="ekyc-head-p"> Attendance Solution</span>
                    </h2> 
                    <p className="ekyc-head-padding dig-pad">Monitoring the attendance efficiently mode easy.</p>
                    <form className="subscribe_form def-shad" onSubmit={(e)=>{e.preventDefault();window.addrecord()}}>
                        <div className="input-group">
                        <input type="hidden" id="source" value="Synzap" />
        ...
        <div className="container">
            <div className="row">
                <div className="col-md-10 col-md-offset-1 col-xs-12 text-center">
                    <h2 className="def-h2">SYNZAP is so flexible, how?</h2>
                </div>
            </div>
                ...
                <div className="col-md-10 col-md-offset-1 col-xs-12">
                    <div className="row text-center">
                        <div className="col-md-3 col-sm-6 kyc-off-box-sp">
                            <div className="def-shad valign-center">
                                <div className="kyc-off-box">
                                    <img className="kyc-off-img" src="./images/synzap/easy-integrate.svg" />
                                    <h4>Easy to integrate</h4>
                                    <p>With our APIs, SDKs, Gateway we makde the integration process simple</p>
                                </div>
                            </div>
                        </div>
                        <div className="col-md-3 col-sm-6 kyc-off-box-sp">
                            <div className="def-shad valign-center">
                                <div className="kyc-off-box">
                                    <img className="kyc-off-img" src="./images/synzap/scalable.svg" />
                        ...
                        <div className="col-md-3 col-sm-6 kyc-off-box-sp">
                            <div className="def-shad valign-center">
                                <div className="kyc-off-box">
                                    <img className="kyc-off-img" src="./images/synzap/allstatck.svg" />
                                    <h4>Supports all Stack</h4>
                                    <p>Support web,windows,Linux(POS Terminal) & Android</p>
                                </div>
                            </div>
                        </div>
                        <div className="col-md-3 col-sm-6 kyc-off-box-sp">
                            <div className="def-shad valign-center">
                                <div className="kyc-off-box">
                                    <img className="kyc-off-img" src="./images/synzap/synzap-Asset 14.svg" />
                                    <h4>Authenticity of data</h4>
                                    <p>Difficult to break the system which ensures authentic data.</p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <section className="kyc-att-sec" id="features">
        <div className="container">
            <div className="row text-center">
                <div className="col-md-10 col-md-offset-1 col-xs-12">
                    <h2 className="def-h2">How efficient is Syntizen Attendance system(SYNZAP)?</h2>
                </div>
            </div>
                    ...
                    <div className="col-md-6 col-xs-12">
                        <div className="panel panel-default">
                            ...
                            <div id="collapseTwo" className="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                                <div className="panel-body">
                                     Apart from solution costing, a client needs to pay directly to UIDAI for a license fee, bank guarantee, Hardware for hosting the solution, that   DSC, SSL certificates. ASA transaction cost to concern ASA. 
                                </div>
                            </div>
                        </div>
                        <div className="panel panel-default">
                        ...
                        <div className="panel panel-default">
                            ...
                            <div id="collapseFour" className="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFour">
                                <div className="panel-body">
                                    No, you need to pay it to the concern ESP.
                                </div>
                            </div>
                        </div>
                    </div>
