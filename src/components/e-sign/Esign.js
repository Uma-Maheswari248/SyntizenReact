...
export class Zen_aua extends Component {
      ...
      <div>
          ...
          <div className="container">
            <div className="row ekyc-row">
              <div className="col-md-6 col-md-offset-3 col-xs-12 text-center">
                <h2 className="def-h2"> Enabling Organizations to Digitally Sign Documents
                </h2>
                <p className="ekyc-head-padding">Transform your manual documentation process to digital using Syntizen’s eSign.</p>
                <form className="subscribe_form def-shad" onSubmit={(e)=>{e.preventDefault();window.addrecord()}}>
                  <div className="input-group">
                  <input type="hidden" id="source" value="eSign"/>
          ...
          <div className="container">
            <div className="row">
              <div className="col-md-10 col-md-offset-1 col-xs-12 text-center">
                <h2 className="def-h2">Processes that can use eSIGN</h2>
              </div>
            </div>
                ...
                <div className="row text-center">
                  <div className="col-md-4 col-sm-6 kyc-off-box-sp">
                    <div className="def-shad valign-center">
                      <div className="esign-off-box">
                        <img className="kyc-off-img" src="images/eSIGN/customer-onboarding.svg" />
                        <h4>Customer On-boarding</h4>
                        <p>Eliminate paperwork and to eliminate the chances of forged and signatures in the customer onboarding process.</p>
                      </div>
                    </div>
                  </div>
                  <div className="col-md-4 col-sm-6 kyc-off-box-sp">
                    <div className="def-shad valign-center">
                      <div className="esign-off-box">
                        <img className="kyc-off-img" src="images/eSIGN/loan-process.svg" />
                        <h4>Loan processing</h4>
                        <p>Digitally Sign the Loan<br /> Agreements.</p>
                        <br /><br />
                      </div>
                    </div>
                  </div>
                  <div className="col-md-4 col-sm-6 kyc-off-box-sp">
                    <div className="def-shad valign-center">
                      <div className="esign-off-box">
                        <img className="kyc-off-img" src="images/eSIGN/employee-agreements.svg" />
                        <h4>Employee Agreements</h4>
                        <p>Digitally Sign employee agreements between the Company & Employee.</p>
                      </div>
                    </div>
                  </div>
                  <div className="col-md-4 col-md-offset-2 col-sm-6 kyc-off-box-sp">
                    <div className="def-shad valign-center">
                      <div className="esign-off-box">
                        <img className="kyc-off-img" src="images/eSIGN/invoices.svg" />
                        <h4>Invoices</h4>
                        <p> Industries can use eSign to handle a large number of invoices they generate daily.</p>
                      </div>
                    </div>
                  </div>
                  <div className="col-md-4 col-sm-6 kyc-off-box-sp">
                    <div className="def-shad valign-center">
                      <div className="esign-off-box">
                        <img className="kyc-off-img" src="images/eSIGN/rental-agreements.svg" />
                        <h4>Rental agreements</h4>
                        <p> Agreements between owner and tenant of a property.</p>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <section className="kyc-att-sec" id="features">
          <div className="container">
            <div className="row text-center">
              <div className="col-md-10 col-md-offset-1 col-xs-12">
                <h2 className="def-h2">Key Features of the eSIGN</h2>
              </div>
            </div>
            <div className="row text-center esign-key-row">
            <div className="col-md-10 col-md-offset-1 col-xs-12">
              <div className="row text-center">
                <div className="col-md-3 col-sm-6 kyc-off-box-sp">
                <div className="def-shad esign-box-valign-center">
                  <div className="esign-off-box">
                    <img className="kyc-off-img" src="images/eSIGN/easy-integrate.svg" />
                    <h4>Easy integration and configuration</h4>
                  </div>
                </div>
              </div>
              <div className="col-md-3 col-sm-6 kyc-off-box-sp">
                <div className="def-shad esign-box-valign-center">
                  <div className="esign-off-box">
                    <img className="kyc-off-img" src="images/eSIGN/instant.svg" />
                    <h4>Instant Digital Signing of Documents</h4>
                  </div>
                </div>
              </div>
              <div className="col-md-3 col-sm-6 kyc-off-box-sp">
                <div className="def-shad esign-box-valign-center">
                  <div className="esign-off-box">
                    <img className="kyc-off-img" src="images/eSIGN/sign-multiple.svg" />
                    <h4>Sign multiple documents in a single go</h4>
                  </div>
                </div>
              </div>
              <div className="col-md-3 col-sm-6 kyc-off-box-sp">
                <div className="def-shad esign-box-valign-center">
                  <div className="esign-off-box">
                    <img className="kyc-off-img" src="images/eSIGN/cost-time.svg" />
                    <h4>Cost & time efficient</h4>
                  </div>
                </div>
              </div>
              <div className="col-md-3 col-sm-6 col-md-offset-1 esign-off-box-sp">
                <div className="def-shad esign-box-valign-center">
                  <div className="esign-off-box">
                    <img className="kyc-off-img" src="images/eSIGN/legally-valid.svg" />
                    <h4>Legally valid</h4>
                  </div>
                </div>
              </div>
              <div className="col-md-3 col-sm-6 kyc-off-box-sp">
                <div className="def-shad esign-box-valign-center">
                  <div className="esign-off-box">
                    <img className="kyc-off-img" src="images/eSIGN/secure-transaction.svg" />
              ...
              <div className="col-md-3 col-sm-6 kyc-off-box-sp">
                <div className="def-shad esign-box-valign-center">
                  <div className="esign-off-box">
                    <img className="kyc-off-img" src="images/eSIGN/verifiable-signature.svg" />
                    <h4>Verifiable signature</h4>
                  </div>
                </div>
              </div>
              </div>
              ...
              <div className="col-md-10 col-md-offset-1 col-xs-12">
                <div className="row">
                  <div className="col-md-8 trn-left">
                    ...
                    <p>Depends on the number of bussiness applications that eSign to be integrated</p>
                    <br />
                  </div>
